...
DESC = """
# Welcome to the documentation for the parcel API layer!
...
FAKE_USERS_DB = {
    "yellowfoxh4xor@gmail.com": {
        "full_name": "@@ki",
        "username": "yellowfoxh4xor@gmail.com",
...
def main():
    ...
    uvicorn.run("api_parcel:app", host='0.0.0.0', port=8000, reload=True)
